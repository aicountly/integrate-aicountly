 ...
 * integrate.aicountly.com and integrate.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'integrate').trim() || 'integrate'
...
/**
 * `integrate.aicountly.com` and `integrate.gh.aicountly.com` both resolve to
 * `integrate`, which is what the portal expects in authentication_jump.
 */
