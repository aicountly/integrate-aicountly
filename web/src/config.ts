...
export const APP_NAME = (import.meta.env.VITE_APP_NAME ?? 'Integrate').trim() || 'Integrate'
 ...
 * with the app on both integrate.aicountly.com and integrate.gh.aicountly.com. That
