...
Integrate for Aicountly — a React single-page app built with Vite and TypeScript,
with a small PHP API alongside it. Both halves deploy to cPanel.

| Environment | App | API |
| --- | --- | --- |
| Production | https://integrate.aicountly.com | https://integrate.aicountly.com/api |
| Sandbox | https://integrate.gh.aicountly.com | https://integrate.gh.aicountly.com/api |
...
(`https://integrate.gh.aicountly.com/api`) so the token exchange has somewhere to
